...
@rem ##########################################################################
@rem
@rem  maze2D startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and MAZE2_D_OPTS to pass JVM options to this script.
...
@rem Execute maze2D
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MAZE2_D_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.project.maze2D.Application %CMD_LINE_ARGS%
...
:fail
rem Set variable MAZE2_D_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%MAZE2_D_EXIT_CONSOLE%" exit 1
exit /b 1
